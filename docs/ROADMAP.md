...
- **Edición de movimiento existente desde UI**: action `editarMovimiento` existe pero no hay form de edición (solo crear). Reutilizar `MovimientoForm` con valores prellenados + version expected.
